# ATS Resume Scanner
### This desktop application scans for keywords in the resumes provided by the user. Which means it goes through the resumes proided and scans for the keywords the the user wants in the provided resumes. After which it creates a detailed report on by how much percentage(%) the resumes matched the the keywords this report is created as 'report.csv' inside of 'resumes/report' folder.
